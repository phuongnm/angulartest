...
import com.pnm.config.WebMvcJSONConfiguration;
import com.pnm.http.converter.json.BindingResultSerializer;
import com.pnm.http.converter.json.ConversionServiceBeanSerializerModifier;
import com.pnm.http.converter.json.DataBinderBeanDeserializerModifier;
import com.pnm.http.converter.json.FieldErrorSerializer;
